# PT. Alpha Logistics Prakarsa - Management System

Welcome to the ALP Freight Forwarding Management System. This project is a custom-built ERP solution for managing logistics operations, marketing prospects, and accounting.
...
```
The server will run on `http://localhost:5000`. It automatically initializes the SQLite database (`alp_system.db`).
...
4. Point your AI assistant to `ALP-SYSTEM-SPEC.md` for full technical context.
