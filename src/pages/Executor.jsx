                ...
                <tr style={{ borderBottom: '1px solid var(--glass-border)', cursor: 'pointer' }} className="table-row-hover" onClick={() => toggleRow(jo)}>
                  ...
                  <td style={{ padding: '15px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <div style={{ width: '8px', height: '8px', borderRadius: '50%', background: activeTab === 'active' ? '#f59e0b' : '#3b82f6' }} />
                      <span style={{ fontWeight: '600', color: activeTab === 'active' ? '#f59e0b' : '#3b82f6', fontSize: '0.9rem' }}>
                  ...
                  <td style={{ padding: '15px', textAlign: 'center' }}>
                    <div style={{ display: 'flex', justifyContent: 'center', gap: '8px' }}>
                      ...
                      <button 
                        className="btn-icon" 
                        style={{ width: '38px', height: '38px', color: '#3b82f6', background: 'rgba(37, 99, 235, 0.1)', border: '1px solid rgba(37, 99, 235, 0.3)' }}
                                ...
                                <div className="input-group">
                                  ...
                                  {(localData[jo.id]?.containerNo || []).map((c, i, arr) => (
                                    <div key={i} style={{ display: 'flex', gap: '5px', marginBottom: '5px' }}>
                                      ...
                                      <button className="btn-icon" onClick={() => addLocalListItem(jo.id, 'containerNo')} style={{ padding: '5px', height: 'auto', color: '#3b82f6', background: 'rgba(37, 99, 235,0.1)' }} title="Tambah Container">
                                        <Plus size={12} />
                                      </button>
                                    </div>
                                  ))}
                                ...
                                <div className="input-group">
                                  ...
                                  {(localData[jo.id]?.vehicleNo || []).map((v, i, arr) => (
                                    <div key={i} style={{ display: 'flex', gap: '5px', marginBottom: '5px' }}>
                                      ...
                                      <button className="btn-icon" onClick={() => addLocalListItem(jo.id, 'vehicleNo')} style={{ padding: '5px', height: 'auto', color: '#3b82f6', background: 'rgba(37, 99, 235,0.1)' }} title="Tambah Kendaraan">
                                        <Plus size={12} />
                                      </button>
                                    </div>
                                  ))}
                                ...
                                <div className="input-group">
                                  ...
                                  {(localData[jo.id]?.driverName || []).map((d, i, arr) => (
                                    <div key={i} style={{ display: 'flex', gap: '5px', marginBottom: '5px' }}>
                                      ...
                                      <button className="btn-icon" onClick={() => addLocalListItem(jo.id, 'driverName')} style={{ padding: '5px', height: 'auto', color: '#3b82f6', background: 'rgba(37, 99, 235,0.1)' }} title="Tambah Driver">
                                        <Plus size={12} />
                                      </button>
                                    </div>
                                  ))}
