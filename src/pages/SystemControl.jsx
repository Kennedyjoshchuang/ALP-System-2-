...
const SystemControl = () => {
  ...
  const stats = [
    ...
    { label: 'Active Job Orders', value: jobOrders.length, icon: Briefcase, color: '#ed1c24' },
      ...
      <div className="glass-card" style={{ padding: '30px', marginBottom: '40px', border: '1px solid var(--glass-border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
          <div style={{ 
            padding: '15px', 
            borderRadius: '15px', 
            background: maintenanceMode ? 'rgba(245, 158, 11, 0.1)' : 'rgba(37, 99, 235, 0.1)',
            color: maintenanceMode ? '#f59e0b' : '#3b82f6'
          }}>
